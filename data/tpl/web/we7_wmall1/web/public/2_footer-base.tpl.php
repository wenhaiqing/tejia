<?php defined('IN_IA') or exit('Access Denied');?>	<script src="<?php  echo $_W['siteroot'];?>addons/we7_wmall1/resource/web/js/laytpl.js"></script>
	<script src="<?php  echo $_W['siteroot'];?>addons/we7_wmall1/resource/web/js/common.js"></script>
