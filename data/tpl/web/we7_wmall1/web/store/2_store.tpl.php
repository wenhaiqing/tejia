...
<link rel="stylesheet" href="<?php  echo $_W['siteroot'];?>addons/we7_wmall1/resource/web/css/back.css">
<script src="<?php  echo $_W['siteroot'];?>addons/we7_wmall1/resource/web/js/tiny.js"></script>
...
<?php  if($_W['role'] == 'manager' || !empty($_W['isfounder'])) { ?>
	<div class="alert alert-info">
		<i class="fa fa-info-circle"></i> 商户登陆地址:<a href="<?php  echo $_W['siteroot'];?>addons/we7_wmall1/admin" target="_blank"><?php  echo $_W['siteroot'];?>addons/we7_wmall1/admin</a>
	</div>
<?php  } ?>
<?php  if($op == 'post') { ?>
				...
				<div class="checkbox">
					<?php  if(is_array($categorys)) { foreach($categorys as $category) { ?>
						<?php  if($category['is_sys'] == 1) { ?>
							<label><input type="radio" name="cid" value="<?php  echo $category['id'];?>" <?php  if($category['id'] == $item['cid']) { ?>checked<?php  } ?>> <?php  echo $category['title'];?> &nbsp;&nbsp;</label>
						<?php  } ?>
					<?php  } } ?>
				</div>
...
<div class="panel panel-default tab-pane <?php  if($_GPC['type'] == 'takeout') { ?>active<?php  } ?>" role="tabpanel" id="takeout">
	...
	<div class="panel-body">
		...
		<?php  if($_W['we7_wmall1']['config']['sms']['status'] == 1) { ?>
	...
	<div class="panel panel-info">
		...
		<div class="panel-body">
			<form action="./index.php" method="get" class="form-horizontal" role="form">
				...
				<input type="hidden" name="m" value="we7_wmall1">
