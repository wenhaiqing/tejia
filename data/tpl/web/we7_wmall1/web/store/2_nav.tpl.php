<?php defined('IN_IA') or exit('Access Denied');?><ul class="nav nav-tabs">
	<li <?php  if($do == 'store' && $op == 'post') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('store', array('op' => 'post', 'id' => $sid));?>">供应商信息</a></li>
	...
	<!-- <?php  if($_W['we7_wmall1']['store']['account']['delivery_type'] == 1) { ?>
	...
	<!-- <li <?php  if($do == 'place') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('place');?>">供应商代客下单</a></li> -->
</ul>
