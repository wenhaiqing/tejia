	...
	<div class="main">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label"><span class="require">* </span>商品简短介绍</label>
					<div class="col-sm-9 col-xs-12">
						<input type="text" class="form-control"  name="title_description" value="<?php  echo $item['title_description'];?>">
						<div class="help-block">该介绍是显示在APP首页商品名称下面的</div>
					</div>
				</div>	
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label"><span class="require">* </span>厨师年龄</label>
					<div class="col-sm-9 col-xs-12">
						<input type="text" class="form-control"  name="age" value="<?php  echo $item['age'];?>">
						<div class="help-block">如果添加的不是厨师，请忽略</div>
					</div>
				</div>	
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						...
						<div class="help-block">推荐大小: 220*220</div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						...
						<div class="help-block">推荐大小: 220*220, 最多不能超过4张图片</div>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label"><span class="require">* </span>会员价</label>
					<div class="col-sm-9 col-xs-12">
						<input type="text" class="form-control" name="member_price" value="<?php  echo $item['member_price'];?>">
						<div class="help-block"></div>
					</div>
				</div>
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label"><span class="require">* </span>饭店专区批发价</label>
					<div class="col-sm-9 col-xs-12">
						<input type="text" class="form-control" name="hotel_price" value="<?php  echo $item['hotel_price'];?>">
						<div class="help-block"></div>
					</div>
				</div>
				<div class="form-group hide">
				...
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label"><span class="require">* </span>饭店专区商品批发单位</label>
					<div class="col-sm-9 col-xs-12">
						<input type="text" class="form-control" name="hotel_unitname" value="<?php  echo $item['hotel_unitname'];?>">
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label"><span class="require">* </span>人气</label>
					<div class="col-sm-9 col-xs-9 col-md-9">
						<input type="text" class="form-control" name="buzz" value="<?php  echo $item['buzz'];?>">
						<div class="help-block">显示在商品列表页的人气，可自定义</div>
					</div>	
				</div>
				...
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label"><span class="require">* </span>设置为店长推荐</label>
					<div class="col-sm-9 col-xs-9 col-md-9">
						<label class="radio-inline"><input type="radio" name="is_shopowner" value="1" <?php  if($item['is_shopowner'] == 1) { ?>checked<?php  } ?>> 设置</label>
						<label class="radio-inline"><input type="radio" name="is_shopowner" value="0" <?php  if(!$item['is_shopowner']) { ?>checked<?php  } ?>> 不设置</label>
						<div class="help-block">设为店长推荐后,将在首页店长推荐里边显示</div>
					</div>
				</div>
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label"><span class="require">* </span>设置为今日特价</label>
					<div class="col-sm-9 col-xs-9 col-md-9">
						<label class="radio-inline"><input type="radio" name="is_today" value="1" <?php  if($item['is_today'] == 1) { ?>checked<?php  } ?>> 设置</label>
						<label class="radio-inline"><input type="radio" name="is_today" value="0" <?php  if(!$item['is_today']) { ?>checked<?php  } ?>> 不设置</label>
						<div class="help-block">设为今日特卖后,将在首页今日特价里边显示</div>
					</div>
				</div>
				<div class="form-group">
