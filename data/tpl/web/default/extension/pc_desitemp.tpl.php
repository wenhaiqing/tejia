	...
	<form class="form-horizontal form" id="form1" action="" method="post" enctype="multipart/form-data">
		...
		<div class="form-group">
			...
			<div class="col-sm-10 col-xs-12">
					...
					<span class="help-block">模板标识符, 应对应模板文件夹的名称, 微信系统按照此标识符查找模板定义, 只能由字母数字下划线组成 </span>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-10 col-xs-12">
					...
					<span class="help-block">模板的发布页, 用于发布模板更新信息的页面, 推荐使用微信模板版块</span>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-10 col-xs-12">
				...
				<?php  } } ?>
				<span class="help-block">当前模板兼容的微信系统版本, 安装时会判断版本信息, 不兼容的版本将无法安装</span>
			</div>
		</div>
		<div class="form-group">
