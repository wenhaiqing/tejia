...
<link rel="stylesheet" href="<?php  echo $_W['siteroot'];?>addons/we7_wmall2/resource/web/css/back.css">
<script src="<?php  echo $_W['siteroot'];?>addons/we7_wmall2/resource/web/js/tiny.js"></script>
...
<?php  if($_W['role'] == 'manager' || !empty($_W['isfounder'])) { ?>
	<div class="alert alert-info">
		<i class="fa fa-info-circle"></i> 商户登陆地址:<a href="<?php  echo $_W['siteroot'];?>addons/we7_wmall2/admin" target="_blank"><?php  echo $_W['siteroot'];?>addons/we7_wmall2/admin</a>
	</div>
<?php  } ?>
<?php  if($op == 'post') { ?>
...
<div class="panel panel-default tab-pane <?php  if($_GPC['type'] == 'takeout') { ?>active<?php  } ?>" role="tabpanel" id="takeout">
	...
	<div class="panel-body">
		...
		<?php  if($_W['we7_wmall2']['config']['sms']['status'] == 1) { ?>
