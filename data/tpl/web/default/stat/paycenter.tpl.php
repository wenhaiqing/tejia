...
<ul class="nav nav-tabs">
	<li <?php  if($do == 'index') { ?>class="active"<?php  } ?>><a href="<?php  echo url('stat/paycenter')?>">收款记录</a></li>
	<li <?php  if($do == 'chart') { ?>class="active"<?php  } ?>><a href="<?php  echo url('stat/paycenter/chart')?>">收款统计</a></li>
</ul>
<?php  if($do == 'index') { ?>
