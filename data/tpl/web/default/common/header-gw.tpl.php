				...
				<div class="col-xs-12 col-sm-3 col-lg-2 big-menu" style="padding-right: 0px;">
					...
					<div class="panel panel-default">
						...
						<ul class="list-group collapse in" id="frame-1">
							<li class="list-group-item <?php  if($do == 'hardware') { ?> active<?php  } ?>" onclick="window.location.href = '<?php  echo url('cloud/profile');?>';" style="cursor:pointer; overflow:hidden;padding-left: 35px;" kw="注册站点">
									<a class="pull-right" href="<?php  echo url('cloud/profile');?>"><i class="fa fa-cogs"></i></a>
									注册服务站点
							</li>
							<li class="list-group-item <?php  if($do == 'member') { ?> active<?php  } ?>" onclick="window.location.href = '<?php  echo url('cloud/diagnose');?>';" style="cursor:pointer; overflow:hidden;padding-left: 35px;" kw="云服务诊断">
									<a class="pull-right" href="<?php  echo url('cloud/diagnose');?>"><i class="fa fa-user-md"></i></a>
									云服务诊断
							</li>

							<li class="list-group-item" onclick="window.location.href = '<?php  echo url('cloud/appstore');?>';" style="cursor:pointer; overflow:hidden;padding-left: 35px;" kw="应用商城">
									<a class="pull-right" href="<?php  echo url('cloud/appstore');?>"><i class="fa fa-joomla"></i></a>
									应用商城
							</li>
							<li class="list-group-item <?php  if($do == 'addons') { ?> active<?php  } ?>" onclick="window.location.href = '<?php  echo url('cloud/addons');?>';" style="cursor:pointer; overflow:hidden;padding-left: 35px;" kw="商城切换">
									<a class="pull-right" href="<?php  echo url('cloud/addons');?>"><i class="fa fa-paper-plane-o"></i></a>
									商城切换
							</li>
