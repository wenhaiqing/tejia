	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body" style="text-align: center">
				<img style="-webkit-user-select: none" src="<?php  echo $_W['siteroot'] . 'web/' . url('utility/wxcode/qrcode', array('text' => murl('entry', array('m' => 'we7_wmall1', 'do' => 'mgindex'), true, true)));?>">
			</div>
