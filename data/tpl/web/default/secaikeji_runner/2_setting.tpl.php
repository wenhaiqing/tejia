	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<?php  if(is_array($items)) { foreach($items as $item) { ?>
				<div class="item item-style<?php  if($setting['name'] == $item['code']) { ?> active<?php  } ?>">
					<div class="title">
						<div style="overflow:hidden; height:28px;"><?php  echo $item['title'];?></div>
						<a href="<?php echo './index.php?c=profile&a=module&do=setting&m=secaikeji_runner&name='.$item['code']?>">
							<img src="<?php  echo tomedia($item['image'])?>" class="img-rounded" />
						</a>
