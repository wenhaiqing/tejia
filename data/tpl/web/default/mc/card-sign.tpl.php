...
<div style="margin-bottom:15px;">
	<div class="btn-group">
		<a href="<?php  echo url('mc/card/sign', array('op' => 'sign-credit'))?>" class="btn <?php  if($op == 'sign-credit') { ?>btn-primary<?php  } else { ?>btn-default<?php  } ?>">积分策略</a>
		<a href="<?php  echo url('mc/card/sign', array('op' => 'record-list'))?>" class="btn <?php  if($op == 'record-list') { ?>btn-primary<?php  } else { ?>btn-default<?php  } ?>">签到列表</a>
	</div>
</div>
