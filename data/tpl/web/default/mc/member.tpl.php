...
<div class="panel panel-default">
	...
	<div class="panel-body">
		...
		<div class="form-group">
			<label class="col-xs-12 col-sm-3 col-md-2 control-label">是否站长</label>
			<div class="col-sm-9 col-xs-12">
				<select name="bloodtype" class="form-control">

					<option value="1" <?php  if($profile['bloodtype'] == 1) { ?>selected<?php  } ?>>是</option>
					<option value="0" <?php  if($profile['bloodtype'] != 1) { ?>selected<?php  } ?>>否</option>
