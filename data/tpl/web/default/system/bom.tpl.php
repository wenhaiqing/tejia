...
<div class="main">
	...
	<form action="" method="post" class="form-horizontal form">
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<div class="help-block">微信系统使用utf-8无bom格式的文件编码方式, 如果使用编辑器修改配置或者查看文件时没有注意编辑器设置将可能在被编辑的文件上附加BOM头, 从而造成系统功能异常. </div>
				...
				<div class="help-block"><strong>注意: 使用 Windows 系统自带的记事本编辑微信源码可能会造成这样的问题. </strong></div>
			</div>
		</div>
		<div class="form-group">
