			...
			<div class="panel-body">
				<div id="tpl">
					...
					<div class="form-group">
						...
						<div class="col-sm-9 col-xs-12">
							是<input type="radio" name="district" value="1">
							否<input type="radio" name="district" value="0">
						</div>
					</div>
					<div class="form-group">
						<label class="col-xs-12 col-sm-3 col-md-2 control-label">是否属市级分类</label>
						<div class="col-sm-9 col-xs-12">
							是<input type="radio" name="city" value="1">
							否<input type="radio" name="city" value="0">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9 col-xs-12">
							<select name="pid" id="pid" style="width:30%">
								...
								<option value="<?php  echo $li['id'];?>" <?php  if($item['pid'] == $li['id'] || $_GPC['pid'] == $li['id']) { ?>selected<?php  } ?>><?php  echo $li['title'];?></option>
							<?php  } } ?>
							</select>
						</div>
					</div>
				...
				<table class="table table-hover">
					...
					<tbody>
						...
						<tr>
							...
							<?php  if ($pidtitle[$item['pid']]['title']){ ?>
							<td><?php  echo $pidtitle[$item['pid']]['title']?></td>
							<?php  }else{ ?>
							<td>顶级分类</td>
							<?php  } ?>
							...
							<td style="text-align:right;">
								...
								<a href="<?php  echo $this->createWebUrl('category', array('op' => 'update', 'cid' => $item['id']))?>" class="btn btn-default btn-sm" title="编辑分类" data-toggle="tooltip" data-placement="top"><i class="fa fa-edit"> </i></a>
