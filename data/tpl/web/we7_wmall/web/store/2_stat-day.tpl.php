...
<div class="clearfix">
	...
	<form class="form-horizontal" action="" method="post">
		<ul class="order-nav order-nav-tabs">
			...
			<li><a class="btn btn-primary btn-export" href="<?php  echo $this->createWebUrl('stat', array('op' => 'excel', 'addtime[start]' => date('Y-m-d', $starttime), 'addtime[end]' => date('Y-m-d', $endtime), 'orderby' => 'num'))?>"> <i class="fa fa-download"></i> 导出订单</a></li>
		</ul>
		<div class="panel panel-default">
			<div class="panel-body">
