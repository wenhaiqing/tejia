	...
	<?php  } else { ?>
		...
		<div class="navbar navbar-inverse navbar-static-top" role="navigation" style="position:static;">
			<div class="container-fluid">
				<ul class="nav navbar-nav">
					<li class="active">
						<a href="javascript:;" target="_blank"><?php  echo $_W['we7_wmall2']['store']['title'];?></a>
					</li>
				</ul>
				<ul class="nav navbar-nav navbar-right">
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							<li><a href="<?php  echo $this->createWebUrl('clerk', array('op' => 'post', 'id' => $_W['we7_wmall2']['clerk_id']));?>" target="_blank"><i class="fa fa-weixin fa-fw"></i> 我的账号</a></li>
				...
				<div class="col-xs-12 col-sm-3 col-lg-2 big-menu">
					...
					<div class="panel panel-default">
						...
						<ul class="list-group collapse in" id="frame-<?php  echo $k;?>">
							...
							<?php  } else { ?>
								<?php  if($link['title']!='商品分类' && $link['title']!='商品列表' && $link['title']!='配货中心' && $link['title']!='评价管理' && $link['title']!='顾客管理' && $link['title']!='营销活动' && $link['title']!='顾客统计') { ?>
