				...
				<div class="qrcode clearfix">
					<div class="panel panel-default" style="margin-right:35px;">
						...
						<div class="panel-body">
							<img src="<?php  echo $_W['siteroot'] . 'web/' . url('utility/wxcode/qrcode', array('text' => murl('entry', array('m' => 'we7_wmall2', 'do' => 'dyregister'), true, true)));?>">
						</div>
					</div>
					<div class="panel panel-default" style="margin-left:35px;">
						<div class="panel-heading">登陆二维码</div>
						<div class="panel-body">
							<img src="<?php  echo $_W['siteroot'] . 'web/' . url('utility/wxcode/qrcode', array('text' => murl('entry', array('m' => 'we7_wmall2', 'do' => 'dyindex'), true, true)));?>">
						</div>
					</div>
				</div>
			</div>
