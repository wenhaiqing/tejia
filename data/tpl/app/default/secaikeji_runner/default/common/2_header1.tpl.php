...
<head>
	...
	<link rel="stylesheet" href="<?php echo MODULE_URL;?>public/libs/vux/vux.css">
    <link href="<?php echo MODULE_URL;?>public/libs/swiper/css/swiper.css" rel="stylesheet">
    <link rel="stylesheet" href="<?php echo MODULE_URL;?>public/libs/ionic/css/ionic.css?t=<?php  echo time()?>"/>
    <link rel="stylesheet" href="<?php echo MODULE_URL;?>public/css/animate.min.css" />
    ...
    <link type="text/css" rel="stylesheet" href="<?php echo MODULE_URL;?>public/css/mobiscroll.custom-2.15.1.min.css">
    <link type="text/css" rel="stylesheet" href="<?php echo MODULE_URL;?>public/css/ion.rangeSlider.css">
    <link rel="stylesheet" type="text/css" href="<?php echo MODULE_URL;?>public/css/waitting.css"/>
    <style>
	.button{
    ...
    .kb-wall-loading {
		height: 30px;
		background: url(<?php echo MODULE_URL;?>public/images/loading_line.gif) no-repeat 50% 50%;
	}
	.bar.bar-calm {
	    border-color: #005871;
	    background-color: #0D5379;
	...
	<script src="<?php echo MODULE_URL;?>public/js/config.js?t=<?php  echo time()?>"></script>
	<script src="<?php echo MODULE_URL;?>public/js/convertor.js"></script>
</head>
<body ontouchstart>
