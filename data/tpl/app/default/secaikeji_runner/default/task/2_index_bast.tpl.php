...
<link href="<?php echo MODULE_URL;?>public/libs/frozenui/css/frozen.css" rel="stylesheet">
    ...
    <div class="page page-current" id="page-index">
        <div class="content infinite-scroll native-scroll" data-distance="10" style="padding-bottom: 0px;">
            ...
            <div class="j-rmd-types rmd-types">
                ...
                <?php  if(is_array($cats['list'])) { foreach($cats['list'] as $cat) { ?>
            ...
            <?php  if($v_set['shop_runner_best'] == 1) { ?>
...
<script>
    require([
            'jquery','core','weixin',
        '<?php echo MODULE_URL;?>public/libs/vue.min.js',
        '<?php echo MODULE_URL;?>public/libs/vux/components/scroller/index.js',
        '<?php echo MODULE_URL;?>public/libs/vux/components/tab/index.js',
        '<?php echo MODULE_URL;?>public/libs/vux/components/tab-item/index.js',
        '<?php echo MODULE_URL;?>public/libs/jquery_weui/jquery-weui.js',
    ],function($,core,wx,Vue,scroller,tab,tab_item){
        var localId = null;
