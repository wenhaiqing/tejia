...
<div class="page home" id="page-app-index">
	...
	<div class="content">
		...
		<?php  if($_W['we7_wmall1']['config']['imgnav_status'] == 1 && !empty($_W['we7_wmall1']['config']['imgnav_data'])) { ?>
			<div class="row no-gutter sborder activity">
				<?php  if(is_array($_W['we7_wmall1']['config']['imgnav_data'])) { foreach($_W['we7_wmall1']['config']['imgnav_data'] as $i => $nav) { ?>
