...
<div class="page" id="page-delivery-order">
	<header class="bar bar-nav common-bar-nav">
		...
		<h1 class="title">配送管理<?php  if($status == 3) { ?>(<span id="time">5</span>秒后自动刷新)<?php  } ?></h1>
	</header>
					...
					<li class="delivery-others">
						...
						<?php  if($order['delivery_status'] == 4) { ?>
							<div class="order-ls-btn">
								...
								<a href="javascript:;" class="order-success" data-id="<?php  echo $order['id'];?>" data-status="5">确认送达</a>
							</div>
						<?php  } ?>
					</li>
					<?php  } } ?>
