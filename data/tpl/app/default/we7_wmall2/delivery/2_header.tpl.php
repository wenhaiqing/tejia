...
<html>
	<head>
		...
		<title><?php  echo $_W['we7_wmall2']['config']['title'];?>-<?php  echo $title;?></title>
		...
		<link rel="stylesheet" href="../addons/we7_wmall2/resource/app/css/delivery.css" />
		...
		<script type="text/javascript" src="../addons/we7_wmall2/resource/app/js/common.js"></script>
	</head>
	<body>
