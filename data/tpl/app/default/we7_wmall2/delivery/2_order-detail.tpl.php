		...
		<div id="order-detail" class="tab active">
			...
			<div class="list-block other-info" style="margin: 0">
				...
				<div class="table border-no">
					...
					<a href="http://m.amap.com/?q=<?php  echo $store['location_x'];?>,<?php  echo $store['location_y'];?>&name=<?php  echo $store['address'];?>" class="table-cell external">导航</a>
				</div>
			</div> -->
				...
				<div class="order-details-con">
					...
					<div class="inner-con">
						...
						<div class="row no-gutter">
							...
							<div class="col-20 text-right color-black">/<?php  echo $good['unitname'];?></div>
