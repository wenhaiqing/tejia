	...
	<div class="content">
		...
		<div class="grid-nav grid-money border-1px-tb">
			<div class="grid-money-title border-1px-b">
				商家管理
				<?php  if($_W['we7_wmall2']['config']['version'] == 1 && $settle_config['status'] == 1) { ?>
		...
		<div class="service-tel">
			<a href="tel:<?php  echo $_W['we7_wmall2']['config']['mobile'];?>" class="color-danger border-1px-tb">客服热线: <?php  echo $_W['we7_wmall2']['config']['mobile'];?></a>
		</div>
	</div>
</div>
