...
<div class="modal modal-no-buttons modal-qrcode deliveryer-qrcode">
	<div class="modal-inner">
		...
		<div class="modal-text">
			<div class="qrcode">
				<img src="<?php  echo url('utility/wxcode/qrcode', array('text' => murl('entry', array('m' => 'we7_wmall2', 'do' => 'dyorder', 'id' => $order['id'], 'op' => 'consume', 'code' => $order['code']), true, true)));?>" alt=""/>
			</div>
...
<div class="modal modal-no-buttons modal-qrcode clerk-qrcode">
	<div class="modal-inner">
		...
		<div class="modal-text">
			<div class="qrcode">
				<img src="<?php  echo url('utility/wxcode/qrcode', array('text' => murl('entry', array('m' => 'we7_wmall2', 'do' => 'mgorder', 'id' => $order['id'], 'op' => 'consume', 'code' => $order['code']), true, true)));?>" alt=""/>
			</div>
