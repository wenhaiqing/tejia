...
define('WE7_wmall2_ROOT', dirname(dirname(__FILE__)));
define('IS_OPERATOR', true);
require WE7_wmall2_ROOT . '/admin/common/bootstrap.sys.inc.php';
require WE7_wmall2_ROOT . '/admin/common/template.func.php';
require WE7_wmall2_ROOT . '/admin/common/common.func.php';
...
$controllers = array();
$handle = opendir(WE7_wmall2_ROOT . '/admin/source/');
if(!empty($handle)) {
...
$init = WE7_wmall2_ROOT . "/admin/source/{$controller}/__init.php";
if(is_file($init)) {
	require $init;
}
$actions = array();
$handle = opendir(WE7_wmall2_ROOT . '/admin/source/' . $controller);
if(!empty($handle)) {
	while($dir = readdir($handle)) {
...
function _forward($c, $a) {
	$file = WE7_wmall2_ROOT . '/admin/source/' . $c . '/' . $a . '.ctrl.php';
	return $file;
}