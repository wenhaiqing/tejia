...
tiny.linkBrowser = function(callback){
	...
	var modalobj = util.dialog('请选择链接',["./index.php?c=site&a=entry&&do=cmnlink&m=we7_wmall1&callback=selectTinyLinkComplete"],footer,{containerName:'link-container'});
...
tiny.selectfan = function(callback) {
	require(['bootstrap'], function($){
		...
		$Modal.find('#search').on('click', function(){
			...
			$.post("./index.php?c=site&a=entry&&do=cmnfans&m=we7_wmall1&op=list", {key: key}, function(data){
