...
if($op == 'password') {
	...
	pdo_update('tiny_wmall1_deliveryer', array('password' => $password), array('uniacid' => $_W['uniacid'], 'id' => $deliveryer['id']));
...
if($op == 'work_status') {
	...
	pdo_update('tiny_wmall1_deliveryer', array('work_status' => $status), array('uniacid' => $_W['uniacid'], 'id' => $deliveryer['id']));
...
if($op == 'location') {
	...
	pdo_update('tiny_wmall1_deliveryer', array('location_x' => $location_x, 'location_y' => $location_y), array('uniacid' => $_W['uniacid'], 'id' => $deliveryer['id']));
	$data = array(
		'uniacid' => $_W['uniacid'],
	...
	pdo_insert('tiny_wmall1_deliveryer_location_log', $data);
