define(['jquery','weixin'],function($,wx){
   ...
   core.actionSheet = function () {
    ...
    core.go = function(d, params, container) {
        ...
        var url = './index.php?i=' + i + '&j=' + j + '&c=entry&do=' + d + _str + '&m=secaikeji_runner';
    ...
    core.get = function(d, call,t) {
        ...
        var j = core.querystring('j');
        var type = t || 'json';
        var url = './index.php?i=' + i + '&j=' + j + '&c=entry&do=' + d + '&m=secaikeji_runner';
        $.get(url, call,type);
    }
    /**
	 * post请求 
    ...
    core.getScript = function(file, call) {
        var i = core.querystring('i');
        var j = core.querystring('j');
        var url = './index.php?i=' + i + '&j=' + j + '&c=entry&do=loadjs&m=secaikeji_runner';
        $.ajax({
            url: url,
            data: {
                file: file
