...
function showMap(obj,addr,city,latlngData,Zoom){
	...
	// 百度地图API功能
	//启用地图惯性拖拽，默认禁用
    var myIcon = new BMap.Icon("../addons/secaikeji_runner/public/images/ic_Locate.png", new BMap.Size(36,62));
				...
				for(var i= 0,len=obj.length;i<len;i++){
					var name=obj[i]["name"],             //获取下拉列表的地点列表
					    ...
					    li="<li class='citylist' data-longitude='"+lng+"' data-latitude='"+lat+"' data-text='"+name+"' data-addr='"+addr+"'>" +
                            "<i><img src='../addons/secaikeji_runner/public/images/ic_Locate1.png' style='width:1.5rem;height:1.5rem;'/></i>" +
